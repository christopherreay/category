    ...
    { this.init = function(rootElement)
      ...
      this.a.prototype.listen =
          ...
          { var This = this;
            $(this.div())
                .on
                ( "click blur focus focusin focusout load resize scroll unload "        +
      ...
      //     "dataType":  "json",
      //     "data":
      //     { "userID": someHashOrKeyOrSomething,
      //     },
      //     "success":
      //       function(data, status, request)
      //       { debugger;
      //         holoHacker.organisation = new HoloHacker.Organisation(data.organisation);
      //       }
      ...
      { var This = this;
        ...
        $.each
        ( this.data.chains,
          function(key, chainData)
          { This.chains[key].client= new HoloChain(chainData);
          }
        )

        holoHacker.display.organisation.on
            ( "click",
              function (event)
              { var ajaxOptions =
                { "url":       "/scanDir",
                  ...
                  "dataType":  "json",
                  "data":
                  { "orgID": holoHacker.orgID,
                  },
                  "success":
                    function(data, status, request)
                    { holoHacker.organisation.chains = data.chains;
                      $.each( data.chains,
...
$().ready(
  ...
  { $('body').append('<link href="https://fonts.googleapis.com/icon?family=Material+Icons"rel="stylesheet">');
    ...
    HoloHacker = new VPOOP();
    holoHacker = {};

    HoloHacker.init($("body"));
    holoHacker.graphicLoadVersion = "0.0.9.20160726.1639";
  }
);
...
//                 [ [ O.navbarFixedLeft(display.navbar, null, "mainNav", ".navLogo.centerBackgroundImage.visualToolsLogoWords", ".holoHackerScene") ],
//                   //[ ".holoHackerScene.panel.panel-default" ],
...
//     HoloHacker.referenceVisual  = new HoloHacker.ReferenceVisual    ( display.doubleBuffer);
//     HoloHacker.scene            = new HoloHacker.HoloHackerScene( display.navbar.holoHackerScene );
//   };
...
//       function (index, key)
//       { var blueprintItem = HoloHacker.modelClasses[key].getBlueprintItem(modals.constructBlueprint, modals.constructBlueprintContainer)[0];
...
//           modelClass.getModelInstance(HoloHacker.scene.constructContainer);
//           HoloHacker.scene.setCurrentModelClass(modelClass);
//           setTimeout(function() {
...
//   this.HoloHackerScene = function(displayScene)
...
//             );
//   }
//   this.HoloHackerScene.prototype.setCurrentModelClass = function(modelClass)
...
//       { $.each(data.standard,
//             function(index, value)
//             { This[value.name] = new HoloHacker.ModelClass(value);
//             }
//         );
//         $.each
//         ( data.iframe,
//             function(key, value)
//             { value["jsonKey"] = key;
//               This[key] = new HoloHacker.ModelClass_iframe(value);
//             }
//         );
//         setTimeout
//         ( function() 
//           { HoloHacker.display.welcomeOver.toggleClass("opacityZero", true);
     
//             setTimeout
//             ( function()
//               { HoloHacker.displayInterface(HoloHacker.display);
//               },
//               500
//             );
//           },
...
//           This.modelInstance = new HoloHacker.ModelInstance(This, data[0]);
...
//     this.inputFieldHUD  = new HoloHacker.InputFieldHUD(this);
//     this.svgHUD         = new HoloHacker.SVGHUD(this);
//   }
...
//             var inputField = new HoloHacker.ModelFieldInput(This, value);
...
//             var outputField = new HoloHacker.ModelFieldOutput(This, value);
...
//             var visualisationField = new HoloHacker.ModelFieldVisualisation(This, value);
...
//           new HoloHacker.ModelInstance(data.__modelClass, data);
...
//       display.svgTranslatableG.data("holoHacker", {"modelInstance": this});
//       display.rootSVG.on
...
//                 var multiplier          = svgReferenceGBBox.height / ((HoloHacker.referenceVisual.currentReferenceSVG.height / This.svg3dDisplayJSON.svgRelativeHighness) * (svgVisualisationGBBox["height"]));
...
//     if (!(holoHacker.svgStore.hasOwnProperty(svgFileName)))
//     { d3.xml("/static/svg/"+svgFileName+"?ver="+holoHacker.graphicLoadVersion, 'image/svg+xml',
//         function(xml)
...
//           //var svgReferenceVisual  = $(holoHacker.scene.referenceVisual.getSVGData(This.svg3dDisplayJSON.svgRelativeHighness)).clone();
...
//           holoHacker.svgStore[svgFileName]      = $(importedRootG);
//           holoHacker.svgDefsStore[svgFileName]  = $(importedDefs);
...
//   { this.display.svgClonableG = holoHacker.svgStore[this.svg3dDisplayJSON.svgFile].clone();

//     $(this.display.svgVisualisationG).html(this.display.svgClonableG);

//     if (! this.display.addedSVGDefs)
//     { this.display.svgDefsFromFile = holoHacker.svgDefsStore[this.svg3dDisplayJSON.svgFile].clone();
//       $(this.display.svgDefs).html(this.display.svgDefsFromFile);
//       this.display.addedSVGDefs = true;
//     }

//     if (this.userSelectedReferenceSVG)
//     { this.display.svgReferenceG = HoloHacker.referenceVisual.getSVGDataByName  (this.userSelectedReferenceSVG            ).clone();
//     }
//     else
//     { this.display.svgReferenceG = HoloHacker.referenceVisual.getSVGData        (this.svg3dDisplayJSON.svgRelativeHighness).clone();
//     }
...
//     HoloHacker.ReferenceVisualLoader(This, this.svgReferenceDefsByName, refKeys, this, refKeys.length-1, this.svgSelectList);
...
//     }
//     else
//     { HoloHacker.ReferenceVisualLoader(referenceVisual, referenceSVGDataDict, refKeys, referenceVisualDefs, index-1, svgSelectList);
//     }
...
//     d3.xml("/static/svg/referenceSVGs/"+referenceSVGData.fileHandle+".svg?ver=" + holoHacker.graphicLoadVersion, 'image/svg+xml',
//         function(xml)
//         {
...
//     this.context.cookieManager        = HoloHacker.componentCookieManager.register("svg3dCloneTimer");
...
//     display.referenceSVGSelect.on("click", function() { HoloHacker.modelInstanceFocus = modelInstance; } );

//     if (! HoloHacker.referenceVisual.popoverCreated)
//     { $(document).popover
//       ( { "selector":   ".referenceSVGSelect.hudItem",
//           "container":  "body", 
//           "html":       true, 
//           "title":      "Choose reference visual", 
//           "content":    "<div class='referenceSVGSelectListContainer'>"+HoloHacker.referenceVisual.svgSelectList.html()+"</div>", 
//           "placement" : "bottom",
...
//               var modelInstance   = HoloHacker.modelInstanceFocus;
...
//       HoloHacker.referenceVisual.popoverCreated = true;
...
// $().ready(
//   function()
//   { window.HoloHacker = new holoHacker.oop();
...
// // HoloHacker.display.hamburger.on('click', function() {
...
//       //   referenceSVGSelectListContainer.append(holoHacker.scene.referenceVisual.svgSelectList.clone().show());
...
//           // )
//         // );
//         //holoHacker.scene.modelContainerDiv.append(display.customSVGPane);
